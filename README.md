[![Run App MadisonMaloney](https://github.com/JoanneMadison/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/JoanneMadison/GithubActions/actions/workflows/run-app.yaml)
